	<?php class ReCaptchaResponse{public $success;public $errorCodes;
	}
	class ReCaptcha{
	...
	private function _encodeQS($data){$req = "";
	...
	public function verifyResponse($remoteIp, $response){if ($response == null || strlen($response) == 0) {
	...
	$recaptchaResponse->errorCodes = $answers [error-codes];}return $recaptchaResponse;}}?>
